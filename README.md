This repository includes a 2021 build of Roblox's RCCService (which stands for Roblox Cloud Compute Service). RCCService is responsible for rendering Roblox's avatar thumbnails and hosting servers.
